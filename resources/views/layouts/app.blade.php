...
<body class="text-gray-800">
    ...
    {{-- Global confirm/alert dialog. Replaces native confirm()/alert() so every
         action across the app — including destructive admin actions — matches
         the navy/gold/parchment design system instead of breaking into an
         unstyled browser popup. Exposes window.confirmDialog(message, opts)
         and window.alertDialog(message, opts), both returning a Promise. --}}
