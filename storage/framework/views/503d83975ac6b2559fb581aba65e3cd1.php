...
<section class="hero py-20 px-6 text-center text-white relative z-10">
    <div class="max-w-3xl mx-auto relative z-10">
        ...
        <div class="fade-up fade-up-d4 flex flex-wrap justify-center gap-4">
            <a href="<?php echo e(route('voter.login')); ?>" class="btn-gold inline-flex items-center gap-2">
...
<footer class="py-10 px-6 text-center" style="background: #0a1628; border-top: 3px solid var(--gold);">
    ...
    <div class="flex flex-wrap justify-center gap-6 mb-6">
        ...
        <a href="<?php echo e(route('verify.show')); ?>" class="text-sm hover:underline" style="color: var(--gold);">Verify My Vote</a>
        <span style="color: rgba(255,255,255,.2);">|</span>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\JULFAHAD_SSG_EVOTING\resources\views/welcome.blade.php ENDPATH**/ ?>